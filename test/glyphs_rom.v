...
module glyphs_rom(
    ...
    always @(*) begin
        case (c) 
            0:  case(y) 2,6:rb=8'hFC; 3,4,5:rb=8'hC6; 7,8,9:rb=8'hD8; 10:rb=8'hC6; default:rb=0; endcase // R
            1:  case(y) 2,3,4,5,7,8,9,10:rb=8'hC6; 6:rb=8'hFE; default:rb=0; endcase // H
            2:  case(y) 2,10:rb=8'h3C; 3,9:rb=8'h66; 4,5,6,7,8:rb=8'hC3; default:rb=0; endcase // O
            3:  case(y) 2:rb=8'h3F; 3,4,5,6,7,8:rb=8'h0C; 9:rb=8'hCC; 10:rb=8'h78; default:rb=0; endcase // J
